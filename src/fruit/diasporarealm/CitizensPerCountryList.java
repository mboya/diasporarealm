...
public class CitizensPerCountryList extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_citizens_per_country_list);
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = new ProgressDialog(CitizensPerCountryList.this);
		...
		protected void onPostExecute(Void result) {
			...
			adapter = new ArrayAdapter<String>(CitizensPerCountryList.this,
			...
			country_listView.setAdapter(adapter);
			...
			country_listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Intent i = new Intent(CitizensPerCountryList.this,
							CitizensList.class);
